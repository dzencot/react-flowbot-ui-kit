import * as __WEBPACK_EXTERNAL_MODULE__297__ from "react";
...
*/
var aa=__webpack_require__(297),m=__webpack_require__(418),r=__webpack_require__(840);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
__webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = exports.NY = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = __webpack_unused_export__ = undefined;
 ...
 * LICENSE file in the root directory of this source tree.
 */
var e=__webpack_require__(297);function h(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var k="function"===typeof Object.is?Object.is:h,l=e.useState,m=e.useEffect,n=e.useLayoutEffect,p=e.useDebugValue;function q(a,b){var d=b(),f=l({inst:{value:d,getSnapshot:b}}),c=f[0].inst,g=f[1];n(function(){c.value=d;c.getSnapshot=b;r(c)&&g({inst:c})},[a,d,b]);m(function(){r(c)&&g({inst:c});return a(function(){r(c)&&g({inst:c})})},[a]);p(d);return d}
...
var actionTypes_send = types_ActionTypes.Send;
...
function actions_raise(event) {
  if (!utils_isString(event)) {
    return actions_send(event, {
      to: types_SpecialTargets.Internal
    });
  }
...
function resolveActions(machine, currentState, currentContext, _event, actions, preserveActionOrder) {
  ...
  var resolvedActions = flatten(otherActions.map(function (actionObject) {
    ...
    switch (actionObject.type) {
      ...
      case actionTypes_send:
        var sendAction = resolveSend(actionObject, updatedContext, _event, machine.options.delays); // TODO: fix ActionTypes.Init

        if (!environment_IS_PRODUCTION) {
          // warn after resolving as we can create better contextual message here
          utils_warn(!utils_isString(actionObject.delay) || typeof sendAction.delay === 'number', // tslint:disable-next-line:max-line-length
      ...
      default:
        ...
        if (exec_1 && preservedContexts) {
          ...
          resolvedActionObject = _tslib_assign(_tslib_assign({}, resolvedActionObject), {
            exec: function (_ctx) {
              var args = [];
...
function () {
  ...
  _stateInfo) {
    ...
    function dfs(stateNode) {
      ...
      try {
        for (var _b = _tslib_values(getChildren(stateNode)), _c = _b.next(); !_c.done; _c = _b.next()) {
          var child = _c.value;
          dfs(child);
        }
      } catch (e_1_1) {
  ...
  StateNode.prototype.getActions = function (transition, currentContext, _event, prevState) {
    ...
    try {
      for (var resolvedConfig_1 = _tslib_values(resolvedConfig), resolvedConfig_1_1 = resolvedConfig_1.next(); !resolvedConfig_1_1.done; resolvedConfig_1_1 = resolvedConfig_1.next()) {
  ...
  StateNode.prototype.resolveTransition = function (stateTransition, currentState, context, _event) {
    ...
    try {
      for (var actions_1 = _tslib_values(actions), actions_1_1 = actions_1.next(); !actions_1_1.done; actions_1_1 = actions_1.next()) {
    ...
    var _c = __read(partition(resolvedActions, function (action) {
      return action.type === raise || action.type === actionTypes_send && action.to === types_SpecialTargets.Internal;
    }), 2),
        raisedEvents = _c[0],
      ...
      if (states) {
        try {
          for (var _c = _tslib_values(Object.keys(states)), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            if (state.states) {
              try {
                for (var _e = (e_8 = void 0, _tslib_values(state.events)), _f = _e.next(); !_f.done; _f = _e.next()) {
...
function Machine_createMachine(config, options) {
...
;// CONCATENATED MODULE: ./src/utils/idGenerator.ts

/* harmony default export */ const idGenerator = (() => lodash_default().uniqueId());

;// CONCATENATED MODULE: ./src/machine/answeringMachine.ts


const getAnswerData = (config, name) => config.answers.find((answer) => answer.name === name);
/* harmony default export */ const machine_answeringMachine = (Machine_createMachine({
    tsTypes: {},
    id: 'answer-creator',
    ...
    states: {
        waitingQuestionDetails: {
            on: {
                PREPARE_ANSWER: {
                    actions: es_sendParent((context, event) => {
                        ...
                        const nextQuestions = answerData.questionNames.map((questionName) => {
                            const questionData = configuration.questions.find(({ name }) => (name === questionName));
                            return Object.assign(Object.assign({}, questionData), { id: idGenerator() });
                        });
                        const widgetNames = answerData.widgets || [];
                        const widgetData = widgetNames.map((name) => ({ name, id: idGenerator() }));
                        const payload = {
                            answerData,
                            nextQuestions,
                            widgetData,
...
;// CONCATENATED MODULE: ./src/machine/flowbotMachine.ts



const getInitMessages = (config) => (config.initMessages.map((message) => ({
    type: 'bot',
    content: message,
    id: generateId(),
    widgetData: [],
})));
const getInitQuestions = (config) => (config.initQuestions
    .map((questionName) => {
    const questionData = config.questions.find((question) => question.name === questionName);
    return Object.assign(Object.assign({}, questionData), { id: generateId() });
}));
const flowbotMachine_createBotMachine = (configuration) => {
                    ...
                    PREVIOUS: {
                        actions: assign({
                            currentQuestions: (context) => {
                                ...
                                return prevQuestions.map((question) => (Object.assign(Object.assign({}, question), { id: generateId() })));
                            },
                        }),
                    },
                    RESET: {
...
/* harmony default export */ const flowbotMachine = ((/* unused pure expression or super */ null && (flowbotMachine_createBotMachine)));
...
function () {
  ...
  function Interpreter(machine, options) {
    ...
    this.sendTo = function (event, to) {
      ...
      var target = isParent ? _this.parent : utils_isString(to) ? _this.children.get(to) || registry.get(to) : isActor(to) ? to : undefined;
      ...
      if ('machine' in target) {
        ...
        target.send(_tslib_assign(_tslib_assign({}, event), {
    ...
    if (this.state.configuration && isDone) {
      ...
      try {
        for (var _l = _tslib_values(this.doneListeners), _m = _l.next(); !_m.done; _m = _l.next()) {
          ...
          listener(actions_doneInvoke(this.id, doneData));
        }
      } catch (e_5_1) {
        e_5 = {
          error: e_5_1
  ...
  Interpreter.prototype.stop = function () {
    ...
    __spreadArray([], __read(this.state.configuration), false).sort(function (a, b) {
      ...
      try {
        for (var _b = _tslib_values(stateNode.definition.exit), _c = _b.next(); !_c.done; _c = _b.next()) {
          var action = _c.value;
      ...
      case start:
        {
          ...
          if (activity.type === types_ActionTypes.Invoke) {
            ...
            if (!serviceCreator) {
              // tslint:disable-next-line:no-console
              if (!environment_IS_PRODUCTION) {
                utils_warn(false, "No service found for invocation '".concat(activity.src, "' in machine '").concat(this.machine.id, "'."));
              }
...
const GlobalStateContext = (0,external_react_.createContext)({});
/* harmony default export */ const context = (GlobalStateContext);
...
function useActor(actorRef, getSnapshot) {
    ...
    var actorRefRef = (0,external_react_.useRef)(actorRef);
    var deferredEventsRef = (0,external_react_.useRef)([]);
    var subscribe = (0,external_react_.useCallback)(function (handleStoreChange) {
        var unsubscribe = actorRef.subscribe(handleStoreChange).unsubscribe;
        return unsubscribe;
    }, [actorRef]);
    var boundGetSnapshot = (0,external_react_.useCallback)(function () { return getSnapshot(actorRef); }, [
        actorRef,
        getSnapshot
    ]);
    var storeSnapshot = (0,shim.useSyncExternalStore)(subscribe, boundGetSnapshot, boundGetSnapshot);
...
;// CONCATENATED MODULE: ./src/components/BotToggler.tsx




const BotToggler = () => {
    const globalServices = (0,external_react_.useContext)(context);
    const [state, send] = useActor(globalServices.botService);
    return (external_react_.default.createElement(react_bootstrap_esm_Button, { className: "position-absolute flowbot-toggler", onClick: () => send('TOGGLE') }, state.value === 'idle'
        ? 'Click to activate'
        : 'Active! Click to deactivate'));
};
/* harmony default export */ const components_BotToggler = (BotToggler);
...
const Container = /*#__PURE__*/external_react_.forwardRef(({
  bsPrefix,
  fluid,
...
const Spinner = /*#__PURE__*/external_react_.forwardRef(({
  bsPrefix,
  variant,
  animation,
  size,
...
;// CONCATENATED MODULE: ./src/components/QuestionButton.tsx
...
const QuestionButton = ({ text, answerName }) => {
    ...
    return external_react_.default.createElement(react_bootstrap_esm_Button, { className: "mb-2", onClick: onClick }, text);
};
/* harmony default export */ const components_QuestionButton = (QuestionButton);
...
const Row = /*#__PURE__*/external_react_.forwardRef(({
  bsPrefix,
  className,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'div',
...
const Col = /*#__PURE__*/external_react_.forwardRef( // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
(props, ref) => {
  const [{
    className,
    ...colProps
...
;// CONCATENATED MODULE: ./src/components/UserMessage.tsx


const UserMessage = ({ messageData }) => (external_react_.default.createElement(esm_Row, null,
    external_react_.default.createElement(esm_Col, { className: "text-end", md: { span: 8, offset: 4 } }, messageData.content)));
UserMessage.defaultProps = {
    messageData: {
        content: '',
    },
};
/* harmony default export */ const components_UserMessage = (UserMessage);
...
/* harmony default export */ const divWithClassName = (className => /*#__PURE__*/external_react_.forwardRef((p, ref) => /*#__PURE__*/(0,jsx_runtime.jsx)("div", { ...p,
  ref: ref,
...
const CardImg = /*#__PURE__*/external_react_.forwardRef( // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
({
  bsPrefix,
  className,
  variant,
...
const CardHeaderContext_context = /*#__PURE__*/external_react_.createContext(null);
...
const CardHeader = /*#__PURE__*/external_react_.forwardRef(({
  bsPrefix,
  className,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'div',
...
const Card = /*#__PURE__*/external_react_.forwardRef(({
  bsPrefix,
  className,
  bg,
  text,
...
;// CONCATENATED MODULE: ./src/components/Widget.tsx


// @ts-ignore

const Widget = ({ name }) => {
    const { getWidget } = (0,external_react_.useContext)(context);
    const Component = getWidget(name);
    return (external_react_.default.createElement(esm_Row, { className: "mb-2", "data-testid": "widget" },
        external_react_.default.createElement(esm_Col, { md: 8 },
            external_react_.default.createElement(esm_Card, { style: { width: '300px' } },
                external_react_.default.createElement(esm_Card.Body, { className: "overflow-hidden" },
                    external_react_.default.createElement(Component, null))))));
};
/* harmony default export */ const components_Widget = (Widget);

;// CONCATENATED MODULE: ./src/components/BotMessage.tsx



const BotMessage = ({ messageData: { content, widgetData } }) => (external_react_.default.createElement(external_react_.default.Fragment, null,
    external_react_.default.createElement(esm_Row, null,
        external_react_.default.createElement(esm_Col, { md: 8 }, content)),
    widgetData.map(({ name, id }) => external_react_.default.createElement(components_Widget, { key: id, name: name }))));
...
/* harmony default export */ const components_BotMessage = (BotMessage);

;// CONCATENATED MODULE: ./src/components/MessageBox.tsx
...
const messageMapping = (message) => {
    switch (message.type) {
        case 'user':
            return external_react_.default.createElement(components_UserMessage, { key: message.id, messageData: message });
        case 'bot':
            return external_react_.default.createElement(components_BotMessage, { key: message.id, messageData: message });
        default:
...
const MessagesBox = () => {
    ...
    (0,external_react_.useEffect)(() => {
        modules/* animateScroll.scrollToBottom */.NY.scrollToBottom({
            containerId: 'containerElement',
            duration: 0,
        });
    });
    return (external_react_.default.createElement(esm_Container, { "data-testid": "botContainer", id: "containerElement", fluid: "sm", className: "position-absolute overflow-auto shadow p-3 mb-5 bg-body rounded flowbot-message-box" },
        state.context.messages.map((item) => messageMapping(item)),
        external_react_.default.createElement("div", { className: "d-flex flex-column" }, isBotWaitingQuestion(state)
            ? state.context.currentQuestions.map(({ answerName, id, text }) => (external_react_.default.createElement(components_QuestionButton, { key: id, text: text, answerName: answerName })))
            : (external_react_.default.createElement(esm_Spinner, { animation: "border", role: "status" },
                external_react_.default.createElement("span", { className: "visually-hidden" }, "Loading..."))))));
};
/* harmony default export */ const MessageBox = (MessagesBox);

;// CONCATENATED MODULE: ./src/components/TransitionButtons.tsx
...
const TransitionButtons = () => {
    const { botService } = (0,external_react_.useContext)(context);
    ...
    return (external_react_.default.createElement("div", { className: "position-absolute flowbot-history-transition-buttons" },
        external_react_.default.createElement(react_bootstrap_esm_Button, { variant: "secondary", className: "me-2", "data-testid": "prevQuestionBtn", onClick: backToPreviousQuestion, disabled: lodash_default().isEmpty(botService.state.context.questionsChain) }, "Previous question"),
        external_react_.default.createElement(react_bootstrap_esm_Button, { variant: "danger", "data-testid": "resetBtn", onClick: backToInitQuestions }, "Return to start")));
};
/* harmony default export */ const components_TransitionButtons = (TransitionButtons);

;// CONCATENATED MODULE: ./src/components/BotBox.tsx
...
const BotBox = () => {
    ...
    return (external_react_.default.createElement(external_react_.default.Fragment, null,
        isBotActive(state) && external_react_.default.createElement(MessageBox, null),
        isBotActive(state) && external_react_.default.createElement(components_TransitionButtons, null),
        external_react_.default.createElement(components_BotToggler, null)));
};
/* harmony default export */ const components_BotBox = (BotBox);
...
const App_App = ({ botMachine, options }) => {
    const botService = useInterpret(botMachine);
    const { getWidget } = options;
    return (external_react_.default.createElement(context.Provider, { value: { botService, getWidget } },
        external_react_.default.createElement(components_BotBox, null)));
};
App_App.defaultProps = {
    botMachine: {},
    options: {},
};
/* harmony default export */ const components_App = ((/* unused pure expression or super */ null && (App_App)));
...
const init_defaultOptions = {
    getWidget: () => null,
};
/* harmony default export */ const src_init = ((configuration, userDefinedOptions = {}) => {
    const options = Object.assign(Object.assign({}, init_defaultOptions), userDefinedOptions);
    const botMachine = createBotMachine(configuration);
    return React.createElement(App, { botMachine: botMachine, options: options });
});
